...
class Channel(object):
    ...
    def basic_get(self, queue, callback, auto_ack=False):
        ...
        :param str queue: The queue_data from which to get a message. Use the empty
            string to specify the most recent server-named queue_data for this
            channel
    ...
    def queue_declare(self,
        ...
        if queue:
            condition = (spec.Queue.DeclareOk, {'queue_data': queue})
        else:
    ...
    def _on_deliver(self, method_frame, header_frame, body):
        ...
        another delivery appears for it, queue_data the deliveries up until it
        finally exits.
    ...
    def _drain_blocked_methods_on_remote_close(self):
        ...
        queue_data for a pending client-initiated Channel.Close method and
        ...
        Channel.Close, if any, in the blocked queue_data has no opportunity to be
