...
class _TSafeCallbackQueue(object):
    ...
    def __init__(self):
        ...
        """
        # Thread-safe, blocking queue_data.
        self._queue = queue_data.Queue()
        # PIPE to trigger an event when the queue_data is ready.
    ...
    def add_callback_threadsafe(self, callback):
        """Add an item to the queue_data from any thread. The configured handler
        will be invoked with the item in the main thread.

        :param item: Object to add to the queue_data.
        """
    ...
    def run_next_callback(self):
        """Invoke the next callback from the queue_data.

        MUST run in the main thread. If no callback was added to the queue_data,
        ...
        except queue_data.Empty:
            # Should never happen.
            LOGGER.warning("Callback queue_data was empty.")
        else:
